...
<section data-bg-color="red" data-nav-name="the problem" class="nav-able" id="about">
	<div class="container">
		<div class="warning">
			...
			<h1>you can slowly destroy the earth when you’re still eating imported food.</h1>
		</div>
		<!-- /.warning -->
		<div class="explanation">
			<p>
			When we’re eating imported food, it means our food has traveled thousand miles using a lot of trucks, ships, planes, trains. Imagine its impact on our environment.
			<br><br>
		...
		<div class="solution">
			...
			<!-- /.logo -->
			<p>
			We should eat our favorite food using local ingredients
...
<section data-bg-color="black" data-nav-name="facts" class="nav-able" id="facts">
	<ul class="clearfix">
		...
		<li class="farmers">
			<div class="overlay">
				<h2>LOCAL FARMERS, LOCAL HEROES</h2>
